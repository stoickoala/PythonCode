...
# SYSTEMS_FILE_PATH = r"C:\Users\a00555655\OneDrive - ONEVIRTUALOFFICE\Documents\Python Scripts\XFABDashboarder\HOTLPCVDs\DryPumps.txt"
...
systems_query = f'select Description from scada_Production_XFAB_France.dbo.fst_GEN_System where SystemTypeID in ({str(112)}) order by Description'

systems = pd.read_sql_query(systems_query, db_connection).Description.to_list()
...
MAIN_FOLDER_PATH = fr'D:\ASaadat\PythonCode\XFABDashboarder\TMPs\Data_and_Figures'
